            ...
            {showPreview && (
              <div className="border rounded p-4 mt-2 bg-gray-50">
                ...
                {form.watch("useWindowsStyle") ? (
                  <div className="bg-[#F0F0F0] border border-[#DFDFDF] shadow-md overflow-hidden font-sans">
                    {/* Title bar */}
                    <div className="bg-gradient-to-r from-[#0058E1] to-[#2080F6] text-white px-2.5 py-1 flex justify-between items-center">
                      <div className="flex items-center gap-2">
                        <div className="text-base font-semibold flex items-center">
                          ...
                          {form.watch("title") || "System Administrator"}
                        </div>
                      </div>
                      <div className="flex items-center">
                        <button 
                    ...
                    <div className="p-4 flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <p className="font-sans text-sm whitespace-pre-line">{form.watch("message") || "Message content will appear here"}</p>
                      </div>
                    </div>
