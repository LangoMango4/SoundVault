...
async function setupSoundButtonsWorld() {
  try {
    console.log('=== 🎵 SOUNDBUTTONSWORLD SETUP PROCESS 🎵 ===');
    console.log('Step 1: Downloading sound files from soundbuttonsworld.com...');
    
    try {
      // Run the download script
      const { stdout: downloadOutput } = await execAsync('node scripts/download_soundbuttonsworld_v2.js');
